...
describe('ResetPassword', () => {
  ...
  it('should not be able to resest the password using a non-exisitent token', async () => {
    await expect(
      resetPassword.run({
  ...
  it('should not be able to resest the password using a non-exisitent user', async () => {
